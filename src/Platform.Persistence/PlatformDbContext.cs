...
public sealed class PlatformDbContext(DbContextOptions<PlatformDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.ToTable("TaskStepExecutions");
            ...
            entity.Property(x => x.LastFailureClass)
                .HasConversion<string>()
                .HasMaxLength(40);
            entity.Property(x => x.UpdatedAtUtc)
                .HasDefaultValueSql("SYSDATETIMEOFFSET()");
            ...
            entity.HasOne<TaskStepRecord>()
                .WithOne()
                .HasForeignKey<TaskStepExecutionRecord>(
                    x => new { x.TenantId, x.CompanyId, x.TaskId, Id = x.StepId })
                .OnDelete(DeleteBehavior.Cascade);

            entity.HasIndex(x => new { x.TenantId, x.CompanyId, x.IdempotencyKey })
                .IsUnique();
        ...
        modelBuilder.Entity<TaskDispatchRecord>(entity =>
        {
            ...
            entity.Property(x => x.State)
                .HasConversion<string>()
                .HasMaxLength(40)
                .HasDefaultValue(WorkDispatchState.Pending);
            entity.Property(x => x.CreatedAtUtc)
                .HasDefaultValueSql("SYSDATETIMEOFFSET()");
            ...
            entity.HasIndex(
                    x => new { x.TenantId, x.CompanyId, x.TaskId, x.StepId, x.Attempt })
                .IsUnique();
            entity.HasIndex(
                x => new { x.TenantId, x.CompanyId, x.State, x.AvailableAtUtc });
        });
    }
}
