...
/// fails closed before scheduler enqueue.
/// </summary>
    ...
    : ICustomerSlaPriorityAdmissionStore
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            await using var command = CreateSelectCommand(connection, null, admissionId, lockRow: false);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            await using (var select = CreateSelectCommand(connection, transaction, evidence.AdmissionId, lockRow: true))
    ...
    {
        static void Canonical(string value, string name)
        {
        ...
        ArgumentNullException.ThrowIfNull(evidence.Authority);
        Canonical(evidence.Authority.TenantId, nameof(evidence.Authority.TenantId));
        Canonical(evidence.Authority.CompanyId, nameof(evidence.Authority.CompanyId));
